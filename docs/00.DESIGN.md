...
\texttt{the length is 28 bits}&&&& \texttt{number body}\\
\hline
\texttt{Direct f64 literal}&0&0&1&0&0&0&0&Bits[23,0]\\
&&&&&&&&\quad\texttt{index in f64 literal list}\\
\hline
\texttt{Allocated f64 value}&0&0&1&0&0&0&1&Bits[23,0]\\
&&&&&&&&\quad\texttt{index in f64 dynamic list}\\
\hline
\texttt{Direct enum value}&0&0&1&0&0&1&0&\texttt{0x00}&Bits[15,0]\\
&&&&&&&&&\quad\texttt{0 uninitialized}\\
&&&&&&&&&\quad\texttt{1 undefined}\\
&&&&&&&&&\quad\texttt{2 false}\\
&&&&&&&&&\quad\texttt{3 true}\\
&&&&&&&&&\quad\texttt{4 null}\\
&&&&&&&&&\quad\texttt{may record error code here}\\
&&&&&&&&&\quad\texttt{max enum is 0xFFFF}\\
\hline
\texttt{Reserved}&0&0&1&0&0&1&0&\texttt{0x01-0xFF}\\
&0&0&1&0&0&1&1&Bits[23,0]\\
\hline
\texttt{Primitive symbol allocated}&0&0&1&0&1&Bits[25,0]\\
&&&&&&\quad\texttt{index in dynamic}\\
&&&&&&\quad\texttt{symbol list}\\
\hline
\texttt{String literal store}&0&0&1&1&0&0&0&Bits[23,0]\\
&&&&&&&&\quad\texttt{0x000000-0x3FFFFF}\\
&&&&&&&&\quad\quad\texttt{narrow string literal}\\
&&&&&&&&\quad\texttt{0x400000-0x7FFFFF}\\
&&&&&&&&\quad\quad\texttt{wide string literal}\\
&&&&&&&&\quad\texttt{0x800000-0xBFFFFF}\\
&&&&&&&&\quad\quad\texttt{general string literal}\\
\hline
\texttt{Sliced string store}&0&0&1&1&0&0&0&Bits[23,0]\\
&&&&&&&&\quad\texttt{0xC00000-0xFEFFFE}\\
&&&&&&&&\quad\quad\texttt{allocated sliced string}\\
\hline
\texttt{Empty string literal}&0&0&1&1&0&0&0&Bits[23,0]\\
&&&&&&&&\quad\texttt{0xFEFFFF}\\
\hline
\texttt{Direct wide string value}&0&0&1&1&0&0&0&Bits[23,16]&Bits[15,0]\\
\texttt{the length is constant 1}&&&&&&&&\texttt{constant 0xFF}&\texttt{wide char}\\
\hline
\texttt{Direct narrow string value}&0&0&1&1&Bit[26,24]&&&Bits[23,0]\\
\quad\texttt{the length is range [1-3] on 32bit arch}&&&&&\texttt{0b001-0b011}&&&\texttt{char array}\\
\quad\texttt{the length is range [1-7] on 64bit arch}&&&&&\texttt{0b001-0b111}\\
\hline
\texttt{Primitive value: string}&0&1&Bits[28,0]\\
\hline
\texttt{Composite value, possible values:}&1&0&Bits[28,0]\\
