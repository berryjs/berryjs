...
|---------------------------------------------------------------------------------------------------------------------------------------------|-------|-------|-------|----------------------------|-------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------|-------|----------------------------------------------------------|
| Direct Value Integer Number                                                                                                                 |       | 0     | 0     | 0                          | Bits 27 - 0 number body |                                                                                                                                                                                                |                                 |       |                                                          |
...
| Atom Values<br>  Wide String(length > 1)<br>  Narrow String(length > 3)<br>  Symbol/Number                                                  |       | 0     | 0     | 1                          | 1                       | Bit26-Bit0((String 4Byte alignment)(Atom)8 byte alignment) , number is 8byte alignment is the address of the primitive value relative to base address, direct value body, no reference counter |                                 |       |                                                          |
| Primitive Value<br>primitive value can not reference to other value (Symbol/Number/BigInt and any other primitive value(also native value)) |       | 1     | 0     | Pointer to Primitive Value |                         | Reference counter and value body                                                                                                                                                               |                                 |       |                                                          |
| Object Value<br>object value can reference to other value                                                                                   |       | 1     | 1     | Pointer to Object Value    |                         | Reference counter and trace info and nothing more                                                                                                                                              |                                 |       |                                                          |
# Byte-code
