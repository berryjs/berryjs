...
\\ \hline
\textrm{Values relative to based address}&0&0&1&0&Bits[26,24]&&&Bits[23,0]
\\ &&&&& \quad\textrm{0b000 f64 literal}&&&\textrm{offset to base address}
\\ &&&&& \quad\textrm{0b001 f64 allocated with dynamic array}
\\ &&&&& \quad\textrm{0b110 symbol literal}
\\ &&&&& \quad\textrm{0b110 symbol allocated with dynamic array}
\\ \hline
\textrm{Direct enum value}&0&0&1&1&0&0&0&Bits[23,0]
\\ &&&&&&&&\quad\textrm{0 Uninitialized}
\\ &&&&&&&&\quad\textrm{1 Undefined}
\\ &&&&&&&&\quad\textrm{2 False}
\\ &&&&&&&&\quad\textrm{3 True}
\\ &&&&&&&&\quad\textrm{4 Null}
\\ &&&&&&&&\quad\textrm{0xFEFFFF Empty string}
\\ &&&&&&&&\quad\textrm{and so on}
\\ &&&&&&&&\quad\textrm{max enum is 0xFEFFFF }
...
\\ \textrm{the length in range [1-7]}&&&&&\textrm{0b001-0b111}&&&\textrm{char array}
\\ \textrm{compatible with 64bit arch}
\\ \hline
\textrm{String  Primitive Value}&0&1&Bits[28,0]
\\ \hline
\textrm{Other Primitive Value}&1&0&Bits[28,0]
\\ \hline
\textrm{Object Value}&1&1&Bits[28,0]
\\ \hline
\end{array}
$$
...
### Other Primitive Value
 ...
 Other primitive value can not reference to other value
