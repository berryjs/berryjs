...
| Atom Values<br>  Wide String(length > 1)<br>  Narrow String(length > 3)<br>  Symbol<br>  Number                                             |       | 0     | 0     | 1                                                                                                     | 1                         |       |                                 |       |                                                          |
...
| Object Value<br>object value can reference to other value                                                                                   |       | 1     | 1     | Bit28-Bit0 << 3<br>Pointer to Object Value<br>Reference counter and gc trace info and (key value map) |                           |       |                                 |       |                                                          |
