...
| Primitive Value<br>primitive value can not reference to other value<br><br>Possible Values:<br>symbol/number/bigint<br>and any other primitive value (also native value)<br>future<br>object/array |  | 1 | 0 | Bit28-Bit0 << 3<br>Pointer to Primitive Value<br>  Reference counter<br>  value body |  |  |  |  |  |  |  |
