...
# Berry Value Layout
| Bit31 are used for distinguish normal value and error value<br>0 means normal value<br>1 means error value                                                                                                                                                                                                 | Bit31 | Bit30 | Bit29 | Bit28                                                                                                   | Bit27                     | Bit26 | Bit25                              | Bit24 | Bit23                                                                  | Bit22-Bit16 | Bit15-Bit0 |
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------|-------|-------|---------------------------------------------------------------------------------------------------------|---------------------------|-------|------------------------------------|-------|------------------------------------------------------------------------|-------------|------------|
...
| Atom Values (Like literal in source code)<br>  Wide String(length > 1)<br>  Narrow String(length > 3)<br>  Symbol（8 bytes)<br>    4 bytes symbol counter, 0 stands for global symbol, other value increment atomically<br>    4 bytes for Atom/Direct String(Narrow or Wide))<br>  Number (8 byte double) |       | 0     | 0     | 1                                                                                                       | 1                         |       |                                    |       |                                                                        |             |            |
