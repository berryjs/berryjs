...
and `Virtual Machine` (VM). The `Compact Byte Code Generator` using [swc](https://github.com/swc-project/swc)
...
Some of the design referenced to [JerryScript](https://github.com/jerryscript-project/jerryscript/blob/master/docs/04.INTERNALS.md)

## Berry Value Layout
$$
\begin{array}{|l|l|l|l|l|l|l|l|l|l|l|}
\hline
\textrm{Bit31} & \textrm{Bit30} & \textrm{Bit29} & \textrm{Bit28} &
\textrm{Bit27} & \textrm{Bit26} & \textrm{Bit25} & \textrm{Bit24} &
\textrm{Bit23} & \textrm{Bit22-Bit16} & \textrm{Bit15-Bit0}
...
\\ \hline
\textrm{Direct integer number value} & 0 & 0 & 0 & \textrm{Bit27-Bit0}
\\ \textrm{the length is 28 bits} & & & & \textrm{number body}
\\ \hline
\textrm{Direct enum value} & 0 & 0 & 1 & 0 & 0 & 0 & 0 &
\\ \hline
\textrm{Reserved}
\\ \hline
\textrm{Stack allocated number value}
\\ \hline
\textrm{Direct wide string value}
\\ \textrm{the length is constant 1}
\\ \hline
\textrm{Direct narrow string value}
\\ \textrm{the length in range [1-3]}
\\ \hline
\textrm{Direct Enum Number}
\\ \hline
\textrm{Direct Enum Number}
\\ \hline
\textrm{Direct Enum Number}
...
| Bit31 are used for<br>distinguish normal value<br>and error value<br>0 means normal value<br>1 means error value | Bit31 | Bit30 | Bit29 | Bit28 | Bit27 | Bit26 | Bit25 | Bit24 | Bit23 | Bit22-Bit16 | Bit15-Bit0 |
|-|-|-|-|-|-|-|-|-|-|-|-|
| Direct Value Integer Number |  | 0 | 0 | 0 | Bit27-Bit0<br>number body |  |  |  |  |  |  |
| Direct Value Enums |  | 0 | 0 | 1 | 0 | 0 | 0 | 0 | Bit23-Bit0<br>Empty (uninitialized value)<br>Undefined<br>False<br>True<br>Null<br>And so on |  |  |
| Reserved |  | 0 | 0 | 1 | 0 | 0 | 0 | 1 | Bit23-Bit0<br>Not Used |  |  |
| Stack Allocated Number Value |  | 0 | 0 | 1 | 0 | 0 | 1 | 1 | Bit23-Bit0<br>000000 <br>to<br>FEFFFF<br>offset of the memory |  |  |
| Direct Value Wide String (length always 1) |  | 0 | 0 | 1 | 0 | 0 | 1 | 1 | Bit23-Bit16<br>FF |  | Wide Char |
| Direct Value Narrow String (length 1 - 3) |  | 0 | 0 | 1 | 0 | 1 | Bit25-Bit24<br>  stands for length |  | Bit23-Bit0<br>  string body |  |  |
| Atom Values (Like literal in source code)<br>  Wide String(length > 1)<br>  Narrow String(length > 3)<br>  Symbol（8 bytes)<br>    4 bytes symbol counter<br>       0 stands for global symbol<br>       other value increment atomically<br>    4 bytes for Atom/Direct String(Narrow or Wide))<br>  Number (8 byte double) |  | 0 | 0 | 1 | 1 |  |  |  |  |  |  |
| String Primitive Value<br>Can not reference to other value |  | 0 | 1 | Bit28-Bit0 << 3<br>Pointer to String Value<br>  Reference counter<br>  String Length<br>  String body |  |  |  |  |  |  |  |
| Primitive Value<br>primitive value can not reference to other value<br><br>Possible Values:<br>symbol/number/bigint<br>and any other primitive value (also native value)<br>Future primtive values:<br>Records & Tuples |  | 1 | 0 | Bit28-Bit0 << 3<br>Pointer to Primitive Value<br>  Reference counter<br>  value body |  |  |  |  |  |  |  |
| Object Value<br>object value can reference to other value |  | 1 | 1 | Bit28-Bit0 << 3<br>Pointer to Object Value<br>  Reference counter<br>  gc trace info<br>  key value map |  |  |  |  |  |  |  |
