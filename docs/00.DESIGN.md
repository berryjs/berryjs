...
\\ &&&&&&&&\quad\quad\textrm{narrow string literal}
\\ &&&&&&&&\quad\textrm{0x400000-0x7FFFFF}
\\ &&&&&&&&\quad\quad\textrm{wide string literal}
...
* native string literal
  It's record the offset of the native string literal.
  The literal structure are using berry_string_literal_narrow, this is linked into
  the native executable. And their corresponding berry_value are fixed value.
